...
function updateTimer() {
  const targetDate = new Date("march 22, 2026 16:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543884442209'; // Número para el primer botón
  const recipientNumber2 = '543814663266'; // Número para el segundo botón
