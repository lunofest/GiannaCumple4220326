const CACHE_NAME = 'cache-v67'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v67',
    'estilos/styles.css?v67',
    'estilos/mediaQueries.css?v67',
    'javascript/script.js?v67',
